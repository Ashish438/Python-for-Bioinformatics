...
# function fetch_cutadapt for fetching and returning system's cutadapt path
...
# function cutadapt for running the cutadapt command on each file 
...
# main function takes input_file_list as input and passes each file 
# from the list to the cutadapt function
def main(input_file_list):
	# calling fetch_cutadapt_path function and storing result in cutadapt_comm_path 
